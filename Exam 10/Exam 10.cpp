...
public:
	Seminar(const char* title, int max) {


		_naziv = (char*)malloc(20);

		strncpy_s(_naziv, 18, title, 17);
		_maxPredavaca = max;


	};

	bool DodajPredavaca(Predavac p)
	{
	...
	bool OcijeniPredavaca(const char* ID, int NO)
	{
